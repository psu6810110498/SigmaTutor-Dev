...
import { LayoutDashboard, BookOpen, GraduationCap, Users, ShoppingCart, Settings, Menu, X, LogOut } from "lucide-react";
                ...
                <div className="p-4 mt-auto">
                    <div className="flex items-center gap-3 p-3 rounded-xl border border-gray-100 bg-white hover:bg-gray-50 transition-colors cursor-pointer group">
                        ...
                        <div className="flex-1 min-w-0">
                            ...
                            <p className="text-xs text-gray-500 truncate">admin@sigmatutor.com</p>
                        </div>
                    </div>
                    <button className="flex items-center gap-2 text-gray-400 hover:text-red-500 text-xs font-medium mt-3 px-2 transition-colors w-full justify-center">
                        <LogOut size={14} />
                        ออกจากระบบ
                    </button>
                </div>
