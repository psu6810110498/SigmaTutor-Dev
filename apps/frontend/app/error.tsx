        ...
        <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
            <div className="text-center max-w-lg">
                ...
                <div className="flex justify-center gap-4">
                    <button
                        onClick={() => reset()}
                        className="px-6 py-3 bg-blue-600 text-white font-medium rounded-xl hover:bg-blue-700 transition shadow-lg shadow-blue-500/20"
                    >
                        Try Again
                    </button>
                ...
                {process.env.NODE_ENV === 'development' && (
                    <div className="mt-10 p-4 bg-gray-100 rounded-lg text-left overflow-auto max-h-60 text-xs font-mono text-red-600">
                        {error.message}
                        <br />
                        {error.stack}
                    </div>
